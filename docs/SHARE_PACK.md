...
> Meet pilot: plans, weather, and your real closet turned into one less daily decision.
...
The original 18-second landscape and vertical demos were created outside this checkout and are not committed here. Add export-ready copies under `public/demo/` before linking them from GitHub or the live Site.
